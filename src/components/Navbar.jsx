...
const Navbar = () => {
    ...
    return (
        <div className="w-full h-16 md:h-20 flex items-center justify-between px-2 sm:px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 bg-gray-800">
            {/* LOGO */}
            <Link to="" className="flex items-center gap-4 text-2xl font-bold">
                <DisplayImage src="logo.png" alt="Logo" w={32} h={32} />
                <span className="text-white">Jake's Blog</span>
            </Link>
            {/* MOBILE MENU */}
